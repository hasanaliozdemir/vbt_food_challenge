...
class ImageCardWidget extends StatelessWidget {
  ...
  bool? textisUp;
  int? participants;
   ImageCardWidget({Key? key, required this.url,this.height,this.width,this.foodName,this.cooker,this.rating,this.participants,this.textisUp=false}) : super(key: key);
 ...
 TextStyle foodNameTextStyle = const TextStyle(fontSize: 18,fontWeight: FontWeight.bold);
  TextStyle cookerTextStyle = const TextStyle(color: Colors.grey,fontSize: 11,fontWeight: FontWeight.bold);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          if(foodName!=null&&textisUp==true)Text(foodName.toString(),style: foodNameTextStyle,),
          Container(
